...
export const microphones: Microphone[] = [
  ...
  },
  {
    ...
    engineering: 'N/DYM neodymium magnet. "a" suffix = revision with improved internal shock mount and refined response. Supercardioid. 50Hz–19kHz. 300Ω output.',
  ...
  },
  {
    ...
    engineering: 'Same N/DYM platform. Slightly different capsule tuning — less pronounced presence peak than 468. Cardioid. 70Hz–17kHz. 300Ω output.',
  ...
  },
  {
    ...
    engineering: 'Entry-level N/DYM capsule with neodymium magnet in simpler configuration. Supercardioid. 80Hz–14kHz. 150Ω output.',
  ...
  },
  {
    ...
    engineering: 'Purpose-built supercardioid element with hardened steel mesh grille for inside-kick placement. Shaped frequency response via capsule tuning and rear-cavity design — midrange scoop is acoustic, not electronic. Supercardioid rejects hi-hat bleed. 20Hz–10kHz shaped. 45Ω output.',
  ...
  },
  {
    ...
    engineering: 'Unidyne III moving-coil capsule (same element as SM58 without ball grille/pop filter). Pronounced presence peak from capsule resonance + tapered grille geometry. 310Ω output. Die-cast metal body, nearly indestructible. Handles SPL well over 160dB at grille.',
  ...
  },
  {
    ...
    engineering: 'Identical Unidyne III capsule as SM57 — spherical steel mesh grille acts as acoustic diffuser, smoothing presence peak by ~2–3dB vs SM57 flat grille. Ball also serves as integral pop filter. Pneumatic shock mount inside grille reduces handling noise. 300Ω output.',
  ...
  // ── Telefunken Dynamics ──
  {
    ...
    engineering: 'Proprietary moving-coil capsule maintaining pattern shape across frequency range better than most dynamics. Extended 18kHz response via lightweight diaphragm and careful acoustic damping. Precision-machined steel mesh grille manages proximity effect. Low handling noise. 325Ω output.',
  ...
  },
  {
    ...
    engineering: 'Same proprietary capsule as M80 in shorter body. Compact form fits tight spaces around drums and amps. 325Ω output.',
  ...
  },
  {
    ...
    engineering: 'Different capsule tuning than M80 — flatter frequency response with less presence emphasis. Short-body construction. Neodymium magnet, strong output. Well-behaved cardioid with minimal off-axis coloration. 325Ω output.',
  ...
  // ── Other Dynamics ──
  {
    ...
    engineering: 'Large ~1.2-inch diaphragm for high-SPL low-frequency applications. Handles 160+ dB at capsule. Round housing is acoustically functional — chamber behind capsule contributes to mid-scoop through acoustic phase cancellation. 200Ω output.',
  ...
  },
  {
    ...
    engineering: 'Large-diaphragm moving-coil in rugged compact housing. Hypercardioid ~12dB rejection at 110°. 30Hz LF extension notable for this size. Three-unit set makes consistent tom miking ideal. 600Ω output.',
  ...
  },
  {
    ...
    engineering: 'Proprietary aluminum voice coil on custom-tuned diaphragm. Internal shock mount + grille design minimize handling noise and pop. Extended 19kHz response captures harmonics most dynamics truncate. Supercardioid with small rear lobe. All-metal housing. 300Ω output.',
