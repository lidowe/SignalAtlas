...
export const preamps: Preamp[] = [
  // ── Preamp-Only (precision → character) ──
  {
    id: 'pre-pueblo-jr22',
    ...
    engineering: 'DC-coupled, transformerless. 3,000Ω input. Electronically balanced output.',
  ...
  },
  {
    ...
    engineering: 'All-valve "True Tube": EF86 pentode input → 12BH7 dual-triode output stage. Zero ICs, transistors, or solid-state in audio path. Cinemag custom I/O transformers. Point-to-point wiring, film capacitors. ~1,400Ω mic input. Hi-Z DI input routes direct to transformer. External PSU with custom toroidal transformer. -20dB pad, 48V phantom, phase switch.',
  ...
  },
  {
    ...
    rack_units: 2,
    em_zone: 'B',
    character: 'Full channel strip — preamp, 4-band EQ, compressor, and limiter with individual patchbay access to each section. Swiss army knife. Clean to warm depending on tube/transformer drive. Split-section routing gives immense flexibility.',
  ...
  },
  {
    ...
    noise_floor_db: 0,
    has_transformer: false,
    eq_features: 'Empty — available 500 series slot in A-Designs 503HR chassis',
    rack_units: 1,
    em_zone: 'A',
    character: 'Empty slot in the A-Designs 503HR three-slot chassis. Available for any VPR Alliance 500-series module.',
    engineering: 'Unpopulated 500-series slot. The 503HR chassis provides ±16V rails and rear-panel XLR I/O per slot.',
    best_for: ['future expansion'],
  },
  {
    id: 'pre-empty-500-3',
    name: '500 Series Slot 3 (empty)',
    vendor: 'A-Designs',
    channels: 1,
    topology: 'discrete-ss',
    input_z_ohm: 0,
  ...
  },
  {
    ...
    noise_floor_db: -120,
    has_transformer: true,
    eq_features: 'Air and Earth tone controls — high and low frequency tube saturation shaping',
    rack_units: 2,
    em_zone: 'B',
